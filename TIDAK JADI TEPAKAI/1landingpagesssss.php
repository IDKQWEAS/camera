...
<body>
            ...
            <div class="inner-wrapper">
                <div class="header-nav">
                    ...
                    <div class="search-container">
                        ...
                        <div class="search-results" id="resultsBox" style="display: none;">
    ...
    <div class="order-frame">
        ...
        <button class="order-icon add-to-cart-btn" data-id="1"><i class="fa-solid fa-plus"></i></button>
    </div>
    <div class="order-frame">
        <img src="./img/fforder.png" alt="">
        <p class="order-desc">FUJIFILM GFX100 II</p>
        <p class="order-price">Rp 500.000</p>
        <button class="order-icon add-to-cart-btn" data-id="2"><i class="fa-solid fa-plus"></i></button>
    </div>
    <div class="order-frame">
        <img src="./img/fforder.png" alt="">
        <p class="order-desc">FUJIFILM GFX100 II</p>
        <p class="order-price">Rp 1.500.000</p>
        <button class="order-icon add-to-cart-btn" data-id="3"><i class="fa-solid fa-plus"></i></button>
    </div>
    <div class="order-frame">
        <img src="./img/fforder.png" alt="">
        <p class="order-desc">FUJIFILM GFX50S II</p>
        <p class="order-price">Rp 2.500.000</p>
        <button class="order-icon add-to-cart-btn" data-id="4"><i class="fa-solid fa-plus"></i></button>
    </div>
</div>
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    data.forEach(product => {
                        ...
                        img.src = '/img/' + product.gambar; // pastikan path sesuai
